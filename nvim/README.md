...
> `saltytine` with `<your_github_username>` in the commands below
...
```shell
git clone https://github.com/saltytine/Ubuntu-Configs/nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```shell
git clone https://github.com/saltytine/Ubuntu-Configs/nvim.git "${env:LOCALAPPDATA}\nvim"
```
...
| `<leader>`+<kbd>Numpad</kbd>   | Normal | Move around splits                            |
