...
map("n", "<leader>s", ":w<CR>", {})
-- Move around splits
map("n", "<leader>w8", "<C-w>k", { desc = "switch window up (top row)" })
map("n", "<leader>w4", "<C-w>h", { desc = "switch window left (top row)" })
map("n", "<leader>w5", "<C-w>j", { desc = "switch window down (top row)" })
map("n", "<leader>w6", "<C-w>l", { desc = "switch window right (top row)" })

map("n", "<kNumpad8>", "<C-w>k", { desc = "switch window up (numpad)" })
map("n", "<kNumpad4>", "<C-w>h", { desc = "switch window left (numpad)" })
map("n", "<kNumpad5>", "<C-w>j", { desc = "switch window down (numpad)" })
map("n", "<kNumpad6>", "<C-w>l", { desc = "switch window right (numpad)" })
